...
#import "ProfileMamanger.h"

#import "Util.h"
#import "ImageManager.h"

@implementation ProfileMamanger

#pragma mark - singleton
DEFINE_SINGLETON(ProfileMamanger);
...
+ (void) requestUserProfileWithNumberID:(NSNumber *)ID andHandler:(SEL)handler andTarget:(id)target
{
	...
	{
		// bind handler
		[ProfileMamanger bindNumberID:ID withHandler:handler andTarget:target];	
