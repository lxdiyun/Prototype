...
//  Prototype
//
//  Created by Adrian Lee on 01/06/12.
...
typedef enum COMMENT_MESSAGE_TYPE_ENUM
{
	REQUEST_NEWER = 0x0,
	REQUEST_OLDER = 0x1,
...
{	
	...
	if (YES == forward)
	{
		[params setValue:@"true" forKey:@"forwarding"];
	}
	else
	{
		[params setValue:@"false" forKey:@"forwarding"];
	}
